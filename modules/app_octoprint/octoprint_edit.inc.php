...
*/
  ...
  //updating 'OCT_CONNECTIONSTATE' (varchar)
   $rec['OCT_CONNECTIONSTATE']=gr('oct_connectionstate');
  //updating 'OCT_CURRENTSTATUS' (varchar)
   $rec['OCT_CURRENTSTATUS']=gr('oct_currentstatus');
  //updating 'OCT_LEFTTIME' (varchar)
   $rec['OCT_LEFTTIME']=gr('oct_lefttime');
